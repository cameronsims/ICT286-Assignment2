...
function user_fetch(onload = null) {
	...
	xhr.send("cs_ulog=" + cookie_get("cs_ulog") + "&cs_shoppingcart=" + cookie_get("cs_shoppingcart"));
};
...
function admin_changeOne(tuple, onload = function() {}) {
	...
	query += "&cs_ulog=" + cookie_get("cs_ulog") + "&cs_shoppingcart=" + cookie_get("cs_shoppingcart");
